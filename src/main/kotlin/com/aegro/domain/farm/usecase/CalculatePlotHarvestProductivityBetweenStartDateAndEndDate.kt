...
@Named
class CalculatePlotHarvestProductivityBetweenStartDateAndEndDate(
    ...
    override suspend fun execute(farmId: String, plotId: String, startDate: LocalDate?, endDate: LocalDate?): Result<Int, Exception> {
        ...
        return calculatePlotHarvestsProductivityBetweenStartDateAndEndDate(plots, plotId, startDate!!, endDate!!)
                ?.let {
                    Success(it)
