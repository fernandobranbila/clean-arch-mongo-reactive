...
internal class CalculatePlotHarvestProductivityBetweenStartDateAndEndDateTest {
    ...
    fun `calculate successfully`() = runBlockingTest {
        ...
        val target = CalculatePlotHarvestProductivityBetweenStartDateAndEndDate(findFarmByIdOutbound)
        ...
        val expectedResult = calculatePlotHarvestsProductivityBetweenStartDateAndEndDate(farm.plots, selectedPlot.id!!, startDate, endDate)
    ...
    private fun calculatePlotHarvestsProductivityBetweenStartDateAndEndDate(plots: List<Plot>?, plotId: String, startDate: LocalDate, endDate: LocalDate) =
